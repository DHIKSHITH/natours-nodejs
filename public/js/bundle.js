...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGljaHUyNSIsImEiOiJja2Nrb2o3cTkxOHpvMnNvMzdlendxcWhnIn0.WUEIs2j-b2701kwDZ73-vg';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>".concat(loc.day, ":").concat(loc.description, "</p>")).addTo(map); //extends the map bounds to include the current location
